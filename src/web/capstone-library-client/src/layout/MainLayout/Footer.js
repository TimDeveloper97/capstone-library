            ...
            <div className="row">
                ...
                <div className="col-lg-3 responsive-column-half">
                    <div className="footer-item">
                        ...
                        <ul className="generic-list-item generic-list-item-hover-underline pt-3 generic-list-item-white">
                            <li><a href="#"><i className="la la-facebook mr-1"></i> Facebook</a></li>
                            <li><a href="#"><i className="la la-twitter mr-1"></i> Twitter</a></li>
                            <li><a href="#"><i className="la la-linkedin mr-1"></i> LinkedIn</a></li>
                            <li><a href="#"><i className="la la-instagram mr-1"></i> Instagram</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div className="container">
            <div className="row align-items-center pb-4 copyright-wrap">
                <div className="col-lg-6">
                    ...
                    <img src="images/logo-white.png" alt="footer logo" className="footer-logo" />
                </a>
                </div>
                <div className="col-lg-6">
                    <p className="copyright-desc text-right fs-14">Copyright &copy; 2023 <a href="#">Capstone</a></p>
                </div>
            </div>
        </div>
    </section>
