import { faCloudArrowDown, faDongSign } from '@fortawesome/free-solid-svg-icons';
    ...
    <section className="newest-post-section" style={{marginTop: '40px'}}>
      <div className="container">
        <h5 className="newpost-title">
          <FontAwesomeIcon icon={faCloudArrowDown} color="#FD8A8A" /> Truyện mới cập nhật
        </h5>
        <div className="row">
          {books &&
