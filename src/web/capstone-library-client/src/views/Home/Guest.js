        ...
        <div className="container">
          <div className="text-center">
            ...
            <p className="section-desc w-50 mx-auto">
              Nếu bạn chưa có nhu cầu đăng ký thành viên, bạn vẫn có thể
              thực hiện nhiều tác vụ tại website của chúng tôi
            </p>
          </div>
              ...
              <div className="card card-item hover-y text-center">
                <div className="card-body">
                  ...
                  <p className="card-text pb-4">
                    Bạn có thể tìm kiếm những cuốn sách tại thư viện,
                    cũng như tìm hiểu về nó qua mô tả.
                  </p>
                  <a href="home-2.html" className="btn theme-btn">
            ...
            <div className="col-lg-4 responsive-column-half">
              <div className="card card-item hover-y text-center">
                <div className="card-body">
                  ...
                  <p className="card-text pb-4">
                    Tham khảo trending về mượn sách trên website để cập nhật xu hướng đọc sách hiện nay
                  </p>
                  <a href="free-demo.html" className="btn theme-btn bg-3">
            ...
            <div className="col-lg-4 responsive-column-half">
              <div className="card card-item hover-y text-center">
                <div className="card-body">
                  ...
                  <p className="card-text pb-4">
                    Đặc biệt có rất nhiều quyền lợi khi đăng ký tài khoản thành viên,
                    một cách rất dễ dàng.
                  </p>
                  <a href="careers.html" className="btn theme-btn">
